    ...
    <div class="login-page">
      <div class="login-container">
        ...
        <div class="info-message">
          <p>
            Con la TMC puedes realizar trámites que
            <strong>solo requieren identificación</strong>. Para realizar trámites que
            requieren firma digital hay que utilizar BakQ u otro certificado
            digital.
          </p>
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        console.log('Login successful - emitting login-success, token:', token); // Add this line
        emit('login-success');
      } else {
